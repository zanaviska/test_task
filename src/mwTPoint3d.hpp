...
public:
    ...
    */
    ...
    {
        return elems[0] == tc.elems[0] && elems[1] == tc.elems[1] && elems[2] == tc.elems[2];
    };
    ...
    */
    ...
    {
        if (idx > 2) throw misc::mwIdxRangeException(2, idx);
        return elems[idx];
    };
...
*/
template <class T>
inline const mwTPoint3d<T> operator+(const mwTPoint3d<T> &first, const mwTPoint3d<T> &second)
{
...
*/
template <class T>
inline const mwTPoint3d<T> operator*(const mwTPoint3d<T> &pt, const double &factor)
{
...
*/
template <class T>
inline const mwTPoint3d<T> operator*(const double &factor, const mwTPoint3d<T> &pt)
{
    return mwTPoint3d<T>(pt.x() * factor, pt.y() * factor, pt.z() * factor);
};
...
*/
template <class T> inline double operator*(const mwTPoint3d<T> &first, const mwTPoint3d<T> &second)
{
...
/*!Normalized representation of the vector (3d point)
    ...
    \returns const 3d point
*/
template <class T> inline const mwTPoint3d<T> operator!(const mwTPoint3d<T> &vector)
{
    mwTPoint3d<T> result;
